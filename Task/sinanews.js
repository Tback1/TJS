...
`sy_signurl_snews`)
   if (signheaderVal) $.setdata(signheaderVal, `sy_ck_snews`)
   $.msg($.name, `获取签到地址: 成功`, ``)
 }
  ...
  $.log(`infourlVal:${infourlVal}`)
  $.log(`infoheaderVal:${infoheaderVal}`)
  if (infourlVal) $.setdata(infourlVal,
`sy_info_snews`)
