...
!(async () => {
  ...
  $.res = await getAuthorShareCode('127.0.0.1/jxmc.json')
  if (!$.res) {
    $.http.get({url: '127.0.0.1/jxmc.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(1000)
    $.res = await getAuthorShareCode('124.0.0.1/jxmc.json')
  }
